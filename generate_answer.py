...
def base_model_chatbot(messages):
    system_message = [
        {"role": "system", "content": "You are an AI interviewer for AI-related and behavioral roles. Ask interview questions, evaluate candidate responses, and provide constructive feedback. Adapt your follow-up questions based on the candidate's previous answers."}]
